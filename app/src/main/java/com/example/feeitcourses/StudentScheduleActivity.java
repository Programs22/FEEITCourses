...
public class StudentScheduleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEnrolledCourses = new ArrayList<>();
        ...
        mEnrolledCoursesReference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                String student = snapshot.getKey().split("_")[2];

                if (mStudentUsername.equals(student)) {
                    mEnrolledCourses.add(snapshot.getValue(Course.class));
                    setSchedule();
                }
            }
        ...
        mCourseScheduleAdapter = new CourseScheduleAdapter(mSchedule, R.layout.schedule, this, mStudentUsername);
    ...
    public void setSchedule() {
        ...
        do {
            ...
            if (!currentDay.equals("Sunday") && !currentDay.equals("Saturday") && !currentDay.equals("Invalid")) {
                for (Course course : mEnrolledCourses) {
